...
def _rreload(module, paths=None, mdict=None, base_module=None, blacklist=None, reloaded_modules=None):
        ...
        if type(attribute) is ModuleType and attribute.__name__ not in blacklist:
            if attribute not in mdict[module]:
                if attribute.__name__ not in sys.builtin_module_names:
                        ...
                        reloaded_modules = _rreload(attribute, paths, mdict, base_module, blacklist, reloaded_modules)
